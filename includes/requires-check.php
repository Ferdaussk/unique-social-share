...
// For elementor
function usshare_share_register_required_plugins() {
	...
	if (usshare_addon_install()) {
		...
		$bwd_plugin_the_notice_is = '<p><b>Unique Social Share</b> requires Elementor to be activated.</p>';
		...
		$bwd_plugin_the_notice_is = '<p><b>Unique Social Share</b> requires Elementor to be installed and activated.</p>';
...
function usshare_admin_notice_minimum_elementor_version() {
	...
	$bwd_plugin_the_notice_is = '<p><b>Unique Social Share</b> does not work since you are using an older version of Elementor</p>';
...
function usshare_addon_install() {
    $file_path = 'elementor/elementor.php';
